...
-- pasted from Claude
vim.opt.expandtab = true -- always spaces, never tabs
vim.opt.tabstop = 4 -- tab character renders as 4 spaces
...
vim.keymap.set("t", "<Esc>", toggle_side_terminal) --'<C-\\><C-n>', { desc = 'Exit terminal mode' })
...
require("lazy").setup({
  ...
  { dir = '~/adherence.nvim', name = 'adherence.nvim', opts = {} },
        ...
        config = function()
            ...
            vim.api.nvim_create_autocmd("FileType", {
                callback = function(args)
                    ...
                    -- pasted from Claude to hopefully never see real tabs again
